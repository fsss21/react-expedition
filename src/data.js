...
export const frank = {
    title: (
        <>
            экспедиция на землю <br />
            франца-иосифа (ледокол <br />
            «георгий седов»)
        </>
    ),
    images: [
...
export const northern = {
    title: (
        <>
            экспедиция на землю <br />
            франца-иосифа и северную землю <br />
...
export const cheluskin = {
    title: (
        <>
            ...
            «сибиряков» по северному морскому <br />
            пути, которым, руководил шмидт
        </>
    ),
    images: [
        {
...
export const vodopyanov = {
    title: (
        <>
            воздушная экспедиция <br />
            водопьянова михаила <br />
            васильевича на землю франца-иосифа
        </>
    ),
    images: [
        {
...
export const papanin = {
    title: (
        <>
            экспедиция и.д. папанина, артическая <br />
